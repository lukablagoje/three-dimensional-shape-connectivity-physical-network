...
name_list = ['human_neuron','rat_neuron',
            'monkey_neuron','zebrafish_neuron', 'vascular_2','vascular_3','vascular_1','mitochondrial','root_1','root_2','anthill','fruit_fly_4','fruit_fly_2','fruit_fly_3','fruit_fly_4']
N_trials = 5
for name in name_list:
    ...
    #path_id_list = list(set(skeleton_paths['path_id'].values.tolist()))
    path_bodyid_list = list(skeleton_paths[['path_id','source','target']].values)
    ...
    path_bodyid_list = skeleton_paths[['path_id','source','target']].values.tolist()
    all_body_id_list = list(set(list(set(skeleton_paths['source'].values.tolist())) + list(set(skeleton_paths['target'].values.tolist())) ))
    path_bodyid_dict = {}
