...
for name in name_list:
    ...
    path_source = '4. points_segments_synapse_connected/'
    path_save = '5. junction_networks/'
    ...
    healing_done = segments_df[['pt_id1', 'pt_id2', 'segment_type']].copy()
    ...
    df_dict = {'pt_id_1': [], 'pt_id_2': [], 'path_id': [], 'source': [], 'target': [], 'segment_type': []}
        ...
        for edge in sorted_path_edgelists[path_id]:
            if edge[0] != edge[1]:  # Ensure the edge is not a loop back to the same point
                ...
                if not healing_status_row.empty:
                    df_dict['segment_type'].append(healing_status_row['segment_type'].values[0])
                else:
                    df_dict['segment_type'].append('not_available')  # Default value if no match is found
    ...
    df_dict = {'pt_id_1': [], 'x_1': [], 'y_1': [], 'z_1': [], 'radius_1': [], 'pt_id_2': [], 'x_2': [], 'y_2': [], 'z_2': [], 'radius_2': [], 'path_id': [], 'source': [], 'target': [],'segment_type':[]}
    ...
    for i, row in df_segment_labels.iterrows():
        ...
        df_dict['segment_type'].append(row['segment_type'])
