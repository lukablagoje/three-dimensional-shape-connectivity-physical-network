...
name_list = ['human_neuron','rat_neuron','monkey_neuron','zebrafish_neuron',
    'vascular_2','vascular_3','vascular_1','mitochondrial','anthill','root_1','root_2','anthill','fruit_fly_2','fruit_fly_3','fruit_fly_1','fruit_fly_4']
final_results ={}
for name in name_list:
    ...
    if name == 'fruit_fly_3':
        ...
        starting_proportion = 1
    cube_side_list = [proportion/100 * cube_side for proportion in np.arange( starting_proportion,105,5)]
